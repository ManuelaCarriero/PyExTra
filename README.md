...
4. Follow the command line syntax of already described in 1. and 2. for [hybrid_simulation.py](https://github.com/ManuelaCarriero/PyExTra/blob/main/hybrid_simulation.py) and 
