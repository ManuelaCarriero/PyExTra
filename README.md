...
Furthermore, [acfk_DNNregressor.py](https://github.com/ManuelaCarriero/PyExTra/blob/main/acfk_DNNregressor.py) is a *script* that given the autocorrelation values, it estimate the model parameters using a deep neural network built with keras. The autocorrelation values are generated by either [firstmodel_ssa_acfs_ks.py](https://github.com/ManuelaCarriero/PyExTra/blob/main/firstmodel_ssa_acfs_ks.py) or [autorepressor_ssa_acfs_ks.py](https://github.com/ManuelaCarriero/PyExTra/blob/main/autorepressor_ssa_acfs_ks.py) or [toggleswitch_ssa_acfs_ks.py](https://github.com/ManuelaCarriero/PyExTra/blob/main/toggleswitch_ssa_acfs_ks.py).
