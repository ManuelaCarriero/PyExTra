...
In this repository we explore three main genetic circuits described in section __Models__ and provide also programs to analyse simulation data (which can not only be generated!)
