...
* [ODEvsStoch.py](https://github.com/ManuelaCarriero/PyExTra/blob/main/ODEvsStoch.py) is a *script* to compare deterministic approach (Ordinary Differential Equation) vs stochastic simulation results.
