...
\begin{figure}[!ht]
\centering
\includegraphics[scale=0.70]{CWTsignal.PNG}
...
This representation is even more intuitive. The mechanism of conversion from scale to frequency is not studied in this thesis. We can leave some references to the python module that is used and the relative documentation \cite{ssqueezepy},\cite{formuledissqueezepy}.
...
\subsection{CWT}
Thanks to the autocorrelation analysis and the fast fourieri transform we have achieved important information about our gentic models signals. In both cases we have investigated on the periodicity of the signal and in particular the frequencies present in it through the FFT.
...
\begin{figure}[!ht]
\centering
\includegraphics[scale=0.70]{CWTFirstModelka1ki0RNAs.PNG}
...
\begin{figure}[!ht]
\centering
\includegraphics[scale=0.70]{CWTFirstModelka1ki0Proteins.PNG}
...
\begin{figure}[!ht]
\centering
\includegraphics[scale=0.70]{CWTFirstModelka1ki0.5RNAs.PNG}
...
\begin{figure}[!ht]
\centering
\includegraphics[scale=0.70]{CWTFirstModelka1ki0.5Proteins.PNG}
...
Then, what we can immediately notice from the CWT is that in the cases in which the gene tends to be active, the CWT shows a more uniform horizontal colored red or yellow bar at low frequencies suggesting the presence of a signal behind noise that has a constant frequency. This is not the case of the gene that tends to be more inactive than active or the autorepressor signal (see Fig. \ref{CWTFirstModelka0.1ki1RNAs}, \ref{CWTFirstModelka0.1ki1Proteins}, \ref{CWTAutorepressormodelRNAs} and \ref{CWTAutorepressormodelProteins}). In this case we can see yellow long spots that are located at precise time point. In particular for the autorepressor case they are red (suggesting a better overlapping between the wavelet and the signal) spots regularly located in time. In case of autorepressor RNAs signal (Fig.\ref{CWTAutorepressormodelRNAs}) we could even estimate this regularity in time since red elongated spots are located at approximately every 300 seconds (if we consider the unit of measure of time in seconds). This is very interesting if one wants to study the gene expression rate and its dependences.

\newpage

\begin{figure}[!ht]
\centering
\includegraphics[scale=0.70]{CWTFirstModelka0.1ki1RNAs.PNG}
...
\begin{figure}[!ht]
\centering
\includegraphics[scale=0.70]{CWTFirstModelka0.1ki1Proteins.PNG}
...
\begin{figure}[!ht]
\centering
\includegraphics[scale=0.70]{CWTAutorepressormodelRNAs.PNG}
...
\begin{figure}[!ht]
\centering
\includegraphics[scale=0.70]{CWTAutorepressormodelProteins.PNG}
...
%La periodicità dell'espressione genica può fornire uno spunto per la terapia se si capisce da cosa è data.
