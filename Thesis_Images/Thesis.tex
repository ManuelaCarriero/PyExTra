...
\begin{figure}[!ht]
\centering
\includegraphics[scale=0.50]{nfkbschemaconparametriCORRETTO.png}
...
\begin{itemize}
 ...
 \item k1i, the constant of inactivation rate of NF-$\kappa$B (this process is not shown in Fig.\ref{NFkBCompleteScheme}).
...
Hence the rates of activation and inactivation of the four ON/OFF mentioned players are:


%Equazioni degli altri 

%Misuriamo la luce delle lucciole per esempio.
