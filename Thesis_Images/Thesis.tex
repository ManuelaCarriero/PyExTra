...
\label{Firstmodelka1ki0Proteins}
\end{figure}
...
\label{Firstmodelka1ki0.5Proteins}
\end{figure}
...
\label{Firstmodelka0.1ki1Proteins}
\end{figure}
...
\label{AutorepressormodelRNAsASSOMIGLIAALLOSPETTROka0.1ki1}
\end{figure}
...
\label{AutorepressormodelProteinsASSOMIGLIAALLOSPETTROka0.1ki1}
\end{figure}
...
\label{ToggleSwitchModelRNAsGene1}
\end{figure}
...
\label{ToggleSwitchModelProteinsGene1}
\end{figure}
