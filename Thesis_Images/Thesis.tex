...
%I numeri random che ci permettono di simulare quello che in natura abbiamo chiamato la ``stocasticità'' vanno generati in modo preciso + ci abbiamo anche generato i parametri con una distribuzione Gamma come la volevamo noi (in biologia � una distribuzione molto importante).
