# -*- coding: utf-8 -*-
"""
Created on Sun Oct  9 11:31:50 2022
...
if args.time_limit:
    ...
    df.to_csv(file_path.format(actual_dir,"added_gillespiesimulation_autorepressor_results"), sep =" ", index = None, header=True, mode = "w") 
