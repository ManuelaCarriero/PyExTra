# -*- coding: utf-8 -*-
"""
Created on Thu Dec 29 16:28:06 2022
...
#Stiamo parlando del primo modello di sintesi proteica 
#Quindi dobbiamo considerare l'autocorrelazione delle proteine
#Per poter ricavare tutti i k.
columns = ['acfs','k']
...
for i in np.arange(0,999):   
    ...
    df_tot.loc[i] = [autocorr_proteins,rates]
    print(i)
...
df_tot.to_csv(file_path.format(actual_dir,"firstmodel_1000RNASacfs_seed42_scale0.5_nlags5000_k1k2k3k4"), sep =" ", index = None, header=True, mode = "w") 
