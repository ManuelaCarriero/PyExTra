# -*- coding: utf-8 -*-
"""
Created on Fri Oct  7 08:30:45 2022
...
if args.run:
    ...
    df.to_csv(file_path.format(actual_dir,"gillespiesimulation_2_ind_genes_results"), sep =" ", index = None, header=True, mode = "w") 

if args.time_limit:
    
    df.to_csv(file_path.format(actual_dir,"added_gillespiesimulation_2_ind_genes_results"), sep =" ", index = None, header=True, mode = "w") 
...
def save_multiplesimulations_results(N, file_path = file_path):
    ...
    results_names = []
    for n in range(1,N+1):
        results_names.append("gillespieresults_2_ind_genes_seed"+str(n))
